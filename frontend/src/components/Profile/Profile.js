...
const Profile = () => {
    ...
    useEffect(() => {
        const unsubscribe = auth.onAuthStateChanged(async (currentUser) => {
            if (currentUser) {
                ...
                setLoading(true);
                try {
                    const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/profile/${currentUser.uid}`);
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/profile/${user.uid}`, {
                method: "PUT",
                ...
                <>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full p-2 border rounded-md ${editMode ? "border-gray-300" : inputStyles
